...
public class Program
{
    public static void Main()
    {
        ...
        while (input != "System Split")
        {
            ...
            else if (input.StartsWith("DumpAnalyze"))
            {
            ...
            else if (input.StartsWith("Dump"))
            {
                ...
                {
                    Hardware currentHardware = hardware.First(h => h.Name == hardwareName);
                    Dump.AddHardware(currentHardware);
                    hardware.RemoveAll(h => h.Name == hardwareName);
                }
            }
            else if (input.StartsWith("Restore"))
            {
                ...
                Hardware hardwareToRestore = Dump.ReturnHardware(hardwareName);
                Dump.RemoveHardwareFromDump(hardwareName);
